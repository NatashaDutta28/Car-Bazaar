...
class MyAdapter4 extends ArrayAdapter<String> {
    ...
    public MyAdapter4(Context context, String[] values){

        super(context, R.layout.layout_row2, values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View theView = theInflater.inflate(R.layout.layout_row2, parent, false);
